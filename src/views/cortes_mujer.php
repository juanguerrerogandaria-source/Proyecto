...
$cortes   = get_cortes_por_categoria('mujer');
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Cortes de Mujer - Tuya's Barber</title>
</head>
<body>
    ...
    <nav class="navbar">
        <div class="container">
            ...
            <div class="navbar__links">
                ...
                <a href="cortes_hombre.php">Cortes de Hombre</a>
    ...
    <header class="page-header">
        <p class="hero__eyebrow">Para mujer</p>
        <h1>Cortes de Mujer</h1>
        <p>Cortes, coloración, peinados y tratamientos pensados para vos.</p>
    </header>
